...
//Utility function allocate a new min heap node with given character and frequency of the character 
...
//Main function that builds a Huffman Tree and print codes by traversing 
